...
<head>
<title>nanke's blog</title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<link href="src/css/style.css" rel="stylesheet" type="text/css" />
<!-- CuFon: Enables smooth pretty custom font rendering. 100% SEO friendly. To disable, remove this section -->
<script type="text/javascript" src="src/js/cufon-yui.js"></script>
<script type="text/javascript" src="src/js/arial.js"></script>
<script type="text/javascript" src="src/js/cuf_run.js"></script>
<!-- CuFon ends -->
</head>
<body>
<div class="main">
  ...
  <div class="header">
    <div class="header_resize">
      <div class="logo"><h1><a href="Homework.html">ASP<span>.NET</span> <small>put my homework here</small></a></h1></div>
      <div class="menu_nav">
        <ul>
    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <img src="res/img1.jpg" width="625" height="205" alt="image" />
          <p>This is a free CSS website template by <a href="http://sc.chinaz.com/" title="վӤ̘ӄ">sc.chinaz.com</a>. This 
...
which means that you are free to use it for any personal or commercial purpose provided you credit me in the form of a link back to <a href="http://sc.chinaz.com/" title="վӤ̘ӄ">sc.chinaz.com</a>.</p>
      ...
      <div class="sidebar">
        <div class="searchform">
          <form id="formsearch" name="formsearch" method="post" action="">
            ...
            <input name="button_search" src="res/search_btn.gif" class="button_search" type="image" />
          </form>
        </div>
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="http://www.dreamtemplate.com/" title="վӤ̘ӄ">Web Templates</a></li>
          </ul>
        </div>
        <div class="gadget">
          <h2 class="star"><span>Sponsors</span></h2><div class="clr"></div>
          <ul class="ex_menu">
            <li><a href="http://www.dreamtemplate.com" title="վӤ̘ӄ">DreamTemplate</a><br />Over 6,000+ Premium Web Templates</li>
...
<%--  <div class="fbg">
    <div class="fbg_resize">
      <div class="col c1">
        ...
        <a href="#"><img src="res/pix1.jpg" width="58" height="58" alt="pix" /></a>
        <a href="#"><img src="res/pix2.jpg" width="58" height="58" alt="pix" /></a>
        <a href="#"><img src="res/pix3.jpg" width="58" height="58" alt="pix" /></a>
        <a href="#"><img src="res/pix4.jpg" width="58" height="58" alt="pix" /></a>
        <a href="#"><img src="res/pix5.jpg" width="58" height="58" alt="pix" /></a>
        <a href="#"><img src="res/pix6.jpg" width="58" height="58" alt="pix" /></a>
      </div>
      <div class="col c2">
